...
<script>
import { createOrUpdateContract, deleteContract } from '@/api/order/orderManagement'
...
export default {
    ...
    methods: {
        ...
        save() {
            ...
            createOrUpdateContract(data).then(res => {
                if(res.code === 0) {
        ...
        delRecord(row) {
            this.$confirm(`确定要删除“用户订阅合同”？删除后该合同信息无法恢复`, '删除合同', {
