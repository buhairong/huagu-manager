        ...
        <div class="items-wrap">
            <div class="items-line">
                <div class="item">
                    ...
                    <div class="item-content">{{detail.orderAndUserDetail.name || '-'}}</div>
                </div>
                <div class="item">
                    <div class="item-title">身份证号：</div>
                    <div class="item-content">{{detail.orderAndUserDetail.idcard || '-'}}</div>
                </div>
            </div>

            <div class="items-line">
                <div class="item">
                    <div class="item-title">准驾级别：</div>
                    <div class="item-content">{{detail.orderAndUserDetail.driveCarType || '-'}}</div>
                </div>
                <div class="item">
                    <div class="item-title">联系方式：</div>
                    <div class="item-content">{{detail.orderAndUserDetail.mobile || '-'}}</div>
                </div>
            </div>
        </div>
                    ...
                    <div class="img-content">
                        <div class="img-wrap">
                            <div class="img-box">
                                <el-image 
                                    style="width: 160px"
                                    :src="detail.orderAndUserDetail.idcardUrl" 
                                    :preview-src-list="[detail.orderAndUserDetail.idcardUrl]"
                                >
                                </el-image>
                            </div>
                        ...
                        <div class="img-wrap">
                            <div class="img-box">
                                <el-image 
                                    style="width: 160px"
                                    :src="detail.orderAndUserDetail.idcardBackUrl" 
                                    :preview-src-list="[detail.orderAndUserDetail.idcardBackUrl]"
                                >
                                </el-image>
                            </div>
                    ...
                    <div class="img-content">
                        <div class="img-wrap">
                            <div class="img-box">
                                <el-image 
                                    style="width: 160px"
                                    :src="detail.orderAndUserDetail.driverLicenseUrl" 
                                    :preview-src-list="[detail.orderAndUserDetail.driverLicenseUrl]"
                                >
                                </el-image>
                            </div>
                        ...
                        <div class="img-wrap">
                            <div class="img-box">
                                <el-image 
                                    style="width: 160px"
                                    :src="detail.orderAndUserDetail.driverLicenseSecondSheetUrl" 
                                    :preview-src-list="[detail.orderAndUserDetail.driverLicenseSecondSheetUrl]"
                                >
                                </el-image>
                            </div>
