<template>
    <div>
        <el-breadcrumb separator="/">
            ...
            <el-breadcrumb-item class="subscription-plan">设置交车点</el-breadcrumb-item>
        </el-breadcrumb>
                ...
                <div class="wrap">
                    <div class="city-list">
                        <div 
                            ...
                            class="city-wrap"
                        >
                            <div class="city" :class="{'active-city': activeCityId === item.cityId}" @click="changeCity(item.cityId, item.cityName)">
                    ...
                    <div class="address-list">
                        <div class="add-btn-wrap">
                            <div class="add-btn" @click="goSaveCarDeliveryPage('add')">添加交车点</div>
                        </div>
                        <div style="height:calc(100% - 50px)" ref="tableWrap">
                            ...
                            >
                                ...
                                >
                                <template slot-scope="scope">
                                    <div class="table-btn" @click="goSaveCarDeliveryPage('edit', scope.row)">编辑</div>
                                    <div class="table-btn" @click="changeStatus(scope.row)">{{ scope.row.status === 1 ? '停用' : '启用' }}</div>
                                    <div class="table-btn" @click="delAddress(scope.row)">删除</div>
                                </template>
                                </el-table-column>
                            </el-table>
                        </div>
...
<script>
import { selectCarDeliveryAddressDetail, insertOrUpdateCarDeliveryAddressDetail, deleteCarDeliveryAddressDetail } from '@/api/goods/goods'
...
export default {
    ...
    methods: {
        ...
        changeStatus(item) {
            ...
            deleteCarDeliveryAddressDetail(data).then((res) => {
                if (res.code == 0) {
