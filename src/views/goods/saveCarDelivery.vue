<template>
    <div>
        <el-breadcrumb separator="/">
            ...
            <el-breadcrumb-item class="subscription-plan">编辑交车点</el-breadcrumb-item>
        </el-breadcrumb>
                ...
                <div class="wrap">
                        ...
                        <div style="padding-left:30px;">
                            <div class="address-item">
                                ...
                                <div class="address-item-content">
                                    <el-input class="wecars-input" v-model="deliveryInfo.deliveryName" :maxlength="50" placeholder="请输入交车点名称" ></el-input>
                                </div>
                            </div>
                            ...
                            <div class="address-item">
                                ...
                                <div class="address-item-content">
                                    <el-input class="wecars-input" v-model="deliveryInfo.deliveryAddress" :maxlength="100" placeholder="请输入交车点详细地址" ></el-input>
                                </div>
                            </div>
                            ...
                            <div class="address-item">
                                ...
                                <div class="address-item-content">
                                    ...
                                    >
                                        <img v-if="deliveryInfo.deliveryPictureUrl" :src="deliveryInfo.deliveryPictureUrl">
                    ...
                    <div class="section" v-if="type === 'edit'">
                        ...
                        <div class="add-btn-wrap">
                            <div class="add-btn" @click="openPersonDialog('add')">添加交车人员</div>
                        </div>

                        <el-table
                            :data="deliveryInfo.personList"
                        >
                            <el-table-column
                                prop="name"
                                label="姓名"
                            ...
                            >
                            <template slot-scope="scope">
                                <div class="table-btn" @click="openPersonDialog('edit', scope.row)">编辑</div>
                                <div class="table-btn" @click="delPerson(scope.row)">删除</div>
                            </template>
                            </el-table-column>
                        </el-table>
                    </div>
        ...
        >
            <div class="address-item">
                ...
                <div class="address-item-content">
                    <el-input class="wecars-input" v-model="curPerson.name" :maxlength="10" placeholder="请输入姓名" ></el-input>
                </div>
            </div>
            ...
            <div class="address-item">
                ...
                <div class="address-item-content">
                    <el-input class="wecars-input" v-model="curPerson.mobile" :maxlength="11" placeholder="请输入电话" :disabled="dialogType === 'edit'"></el-input>
                </div>
            </div>
            ...
            <div class="address-item">
                ...
                <div class="address-item-content" style="line-height: 32px;">交车人员</div>
            </div>
...
<script>
import { selectSingleCarDeliveryAddressDetail, insertOrUpdateCarDeliveryAddressDetail, deleteCarDeliveryUserInfo, addCarDeliveryUserInfo, updateCarDeliveryUserInfo } from '@/api/goods/goods'
...
export default {
    ...
    methods: {
        ...
        addCarDeliveryUserInfo() {
            ...
            addCarDeliveryUserInfo(data).then((res) => {
                if (res.code == 0) {
        ...
        updateCarDeliveryUserInfo() {
            ...
            updateCarDeliveryUserInfo(data).then((res) => {
                if (res.code == 0) {
                    this.$message.success('保存成功')
                    this.handleCloseDialog()
                    this.curPerson = {...initPerson}
        ...
        delPerson(item) {
            this.$confirm('确定要删除这个交车人员吗?', '提示', {
                ...
                deleteCarDeliveryUserInfo(data).then((res) => {
                    if (res.code == 0) {
        ...
        async save() {
            ...
            insertOrUpdateCarDeliveryAddressDetail(data).then((res) => {
                if (res.code == 0) {
